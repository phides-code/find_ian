...
the entered string for the characters ‘i’, ‘a’, and ‘n’. The program should print 
“Found!” if the entered string starts with the character ‘i’, ends with the character 
‘n’, and contains the character ‘a’. The program should print “Not Found!” otherwise. 
...
func main() {
	...
	myString := strings.ToLower(userString)

	if myString[0] != 'i' || !strings.Contains(myString, "a") || myString[len(myString)-1] != 'n' {
		fmt.Printf("Not ")
	}
